...
public class EmailGeneratorService {
    ...
    private String extractResponseContent(String response) {
        ...
        try{
            ObjectMapper mapper = new ObjectMapper();//It can read, write and convert Json Data to java Objects and vice versa.
            JsonNode rootNode = mapper.readTree(response);//readTree is a method that turns the json response in tree like structure.
